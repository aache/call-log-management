...
(
    id integer NOT NULL DEFAULT nextval('tb_transition_id_seq'::regclass) ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT tb_transition_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
(
    id integer NOT NULL DEFAULT nextval('tb_stock_inventory_id_seq'::regclass) ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
